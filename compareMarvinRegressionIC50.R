...
pdf('out/marvin_vs_regression.pdf')
  lims<-range(marvinAlpha$ic50,na.rm=TRUE)
  plot(marvinAlpha$ic50,ic50Fits[,'ic50'],xlab='Marvin IC50',ylab='Regression IC50',main='IFNa2',log='xy',xaxt='n',yaxt='n',xlim=lims,ylim=lims)
